...
constexpr std::initializer_list<player_stats_t> DEFAULT_CLASS_STATS{
    // Index zero is the invalid class thus stats will be zero
    {.attack_skill_points = 0,
     .defense_skill_points = 0,
     .health_skill_points = 0,
     .health = 0,
     .attack = 0,
     .defense = 0,
     .armor = 0},
    {.attack_skill_points = 5,
     .defense_skill_points = 3,
     .health_skill_points = 1,
     .health = MAX_HP,
     .attack = 120,
     .defense = 100,
     .armor = 0}, // Everyone starts with no armor -- naked
    {.attack_skill_points = 1,
     .defense_skill_points = 1,
     .health_skill_points = 1,
     .health = MAX_HP,
     .attack = 120,
     .defense = 50,
     .armor = 0}, // Caster sacrifices defence for its ability to kite enemies
                  // and avoid damage from time to time
    {.attack_skill_points = 1,
     .defense_skill_points = 5,
     .health_skill_points = 5,
     .health = MAX_HP,
     .attack = 60,
     .defense = 150,
     .armor = 0}
    // Tanky sacrifice attack for less damage and you get healing ability
};
